...
var Application
  ...
  try {
    ...
    if (e.code == 'MODULE_NOT_FOUND')
      debug('circumflex-request not found');
    else console.trace(e);
  }
  ...
  try {
    ...
    if (e.code == 'MODULE_NOT_FOUND')
      debug('circumflex-session not found');
    else console.trace(e);
  }
  ...
  try {
    if (conf.auth)
      app.use(require('circumflex-auth')(conf.auth));
  } catch (e) {
    if (e.code == 'MODULE_NOT_FOUND')
      debug('circumflex-auth not found');
    else console.trace(e);
  }
  ...
  try {
    ...
    if (e.code == 'MODULE_NOT_FOUND')
      debug('circumflex-assets not found');
    else console.trace(e);
  }
